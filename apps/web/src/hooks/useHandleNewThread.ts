  ...
  return useCallback(
    (
      ...
      const threadOptions = genericChat
        ...
        : options;
      const carriedRuntimeMode = genericChat ? GENERIC_CHAT_RUNTIME_MODE : carryRuntimeMode;
        ...
        return (async () => {
          ...
          if (workspaceContext) {
            setDraftThreadContext(reusableStoredDraftThread.draftId, {
              ...workspaceContext,
              ...(carriedRuntimeMode ? { runtimeMode: carriedRuntimeMode } : {}),
      ...
      const initialEnvMode = threadOptions?.envMode ?? primaryServerSettings.defaultThreadEnvMode;
      return (async () => {
        setLogicalProjectDraftThreadId(logicalProjectKey, projectRef, draftId, {
          ...
          runtimeMode: carriedRuntimeMode ?? DEFAULT_RUNTIME_MODE,
          ...(carryInteractionMode ? { interactionMode: carryInteractionMode } : {}),
        });
