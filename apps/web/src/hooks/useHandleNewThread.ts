  ...
  return useCallback(
    (
      ...
      const threadOptions = genericChat
        ...
        : options;
      const carryRuntimeMode = resolveNewThreadRuntimeMode(
      ...
      if (emptyStoredDraftThread) {
        return (async () => {
          ...
          if (hasExplicitWorkspaceOption) {
            workspaceContext = pickExplicitWorkspaceOptions(threadOptions);
      ...
      if (
        ...
        if (
          ...
          setDraftThreadContext(currentRouteTarget.draftId, {
            ...pickExplicitWorkspaceOptions(threadOptions),
      ...
      return (async () => {
        const initialEnvMode = threadOptions?.envMode ?? (await resolveDefaultEnvMode());
        if (routeChangedSinceRequest()) {
          return null;
        }
  ...
  const chatProject = useMemo(
    () =>
      chatHostEnvironmentId === null
        ? null
        : findGenericChatProject(projects, chatHostEnvironmentId),
