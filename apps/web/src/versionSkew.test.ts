...
const branding = vi.hoisted(() => ({ APP_BASE_NAME: "Tangent", APP_VERSION: "0.0.34" }));
...
const MISMATCH_HINT = `Version mismatch. Try syncing the client and server to the same ${APP_BASE_NAME} version.`;
