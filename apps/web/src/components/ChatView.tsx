...
export default function ChatView(props: ChatViewProps) {
  ...
  const isGenericChat = activeThread != null && isGenericChatProjectId(activeThread.projectId);
  useEffect(() => {
  ...
  const activeProjectScripts = useMemo(
    () => (activeProject && !isGenericChat ? resolveProjectScripts(settings, activeProject) : []),
    [activeProject, isGenericChat, settings],
  );
  ...
  const gitCwd =
    projectToolsAvailable && activeProject
      ...
      : null;
  const gitStatusCwd = projectToolsAvailable ? (activeThread?.worktreePath ?? gitCwd) : null;
  ...
  const onSend = async (
    ...
    const multipleModelSelections =
      queuedMessage || !projectToolsAvailable ? null : sendCtx.multipleModelSelections;
    if (
      ...
      >
        ...
        >
          ...
          <ChatHeader
            ...
            activeProject={isGenericChat ? null : activeProject}
            openInCwd={isGenericChat ? null : gitCwd}
            activeProjectScripts={isGenericChat ? undefined : activeProjectScripts}
            preferredScriptId={
                    ...
                    <ComposerSurface.Shell contextStrip={showComposerContextStrip}>
                      <ComposerSurface.Host>
                        <div ref={attachDraftHeroComposerAnchorRef} className="relative z-10">
                          <ChatComposer
                            multipleModelSelections={
                              projectToolsAvailable ? multipleModelSelections : null
                            }
