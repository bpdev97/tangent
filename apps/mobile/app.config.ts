    ...
    widgets: [
      {
        ...
        description: `Shows the current state of active ${personalMobile.appName} agents.`,
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSPhotoLibraryAddUsageDescription: `Allow ${personalMobile.appName} to save images to your photo library.`,
  ...
  plugins: [
    ...
    "./plugins/withIosAppShortcuts.cjs",
