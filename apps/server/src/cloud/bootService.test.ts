...
const makeHarness = Effect.fn("test.make_boot_service_harness")(function* (
  ...
  yield* fs.writeFileString(runtime.sentinelPath, cliRuntimeInstallSentinel("1.2.3"));
  ...
  const makeService = (
    ...
    Effect.gen(function* () {
      ...
      yield* fs.writeFileString(paths.sentinelPath, cliRuntimeInstallSentinel(cliVersion));
