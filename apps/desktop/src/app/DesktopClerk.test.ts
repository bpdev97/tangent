...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "bpdev-code-dev" : "bpdev-code",
    legacyUserDataDirName: isDevelopment ? "bpdev-code-dev" : "bpdev-code",
...
describe("DesktopClerk", () => {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "bpdev-code-dev", host: "app" },
          },
        ],
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "bpdev-code-dev" },
    { isDevelopment: false, scheme: "bpdev-code" },
