...
The current upstream comparison baseline is `upstream/main` at `45d9aa90b`, merged into Tangent from
downstream tip `35e493570` on 2026-08-07. Update this line and the dated sync audit whenever the
baseline moves.
