...
| `FORK-DIST-001`    | Installs, updates, and stores state separately from the official app, and ships its own releases                                              | [distribution](docs/fork/distribution.md)               | Planned |
...
| `FORK-CHAT-001`    | Upstream threads always belong to a project; Tangent adds chats with no project attached                                                      | [generic chat](docs/fork/generic-chat.md)               | Planned |
| `FORK-PUSH-001`    | The personal build has no Clerk or managed relay; a self-hosted relay delivers iOS notifications and Live Activities                          | [push relay](docs/fork/push-relay.md)                   | Planned |
| `FORK-IMAGE-001`   | Photos from iPhones must work with every provider: HEIC conversion, mobile shrinking, and camera capture                                      | [image normalization](docs/fork/image-normalization.md) | Planned |
