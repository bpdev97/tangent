...
Tangent adds an instance-scoped Hermes TUI gateway driver. Profile selection, durable cursors, request cancellation, and automation boundaries are documented in the [Hermes maintenance record](../fork/hermes.md).
