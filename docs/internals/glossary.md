...
Cursor, Grok, OpenCode, and Hermes. See [ProviderService.ts][14], [ProviderAdapter.ts][15], and
[CodexAdapter.ts][17] as a representative adapter. Hermes is a Tangent-owned early-access driver.
