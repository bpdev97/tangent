...
it("isProviderSendTurnSupportedImageMimeType accepts normalized raster formats and rejects svg", () => {
  assert.strictEqual(isProviderSendTurnSupportedImageMimeType("image/png"), true);
  assert.strictEqual(isProviderSendTurnSupportedImageMimeType("IMAGE/JPEG"), true);
  assert.strictEqual(isProviderSendTurnSupportedImageMimeType("image/heic"), true);
  assert.strictEqual(isProviderSendTurnSupportedImageMimeType("IMAGE/HEIF-SEQUENCE"), true);
