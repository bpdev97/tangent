...
import {
  ...
  ServerPersonalPushRelayTestResult,
...
const WsHermesAutomationsListRpc = Rpc.make(WS_METHODS.hermesAutomationsList, {
  payload: Schema.Struct({}),
  success: HermesAutomationListResult,
  error: Schema.Union([HermesAutomationError, EnvironmentAuthorizationError]),
});

const WsHermesAutomationsMutateRpc = Rpc.make(WS_METHODS.hermesAutomationsMutate, {
